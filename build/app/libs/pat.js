define('app/libs/pat',function(require,exports,module){
...
/***/ function(module, exports, __webpack_require__) {
  ...
  Watcher.prototype.getValue = function() {
    ...
    try {
      ...
      if (!this.__depend) Watcher.currentTarget = null
      if (true) _.log('error when watcher get the value,please check your expression: "' + this.expObj.exp + '"', e)
    }
